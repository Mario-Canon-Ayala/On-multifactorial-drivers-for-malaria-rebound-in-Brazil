...
formula.1<- Y ~ 1 + f(ID.area.sta,model="bym",graph=AMA.adj) + f(i,model="rw1") + f(ID.mun.ano, model="iid") + despues*Desma  + despues*AGRECU + despues*TUR_V  + despues*DOM  + despues*GAR_MIN + despues*OUT +despues*IMPO
######## Run code to make INLA to 2018
