...
lines(dates,AM$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
lines(dates,AC$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
lines(dates,PA$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
lines(dates,AP$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
lines(dates,RR$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
lines(dates,RO$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
legend("topright", legend=c("P. vivax data","P. vivax prediction","P. falciparum data","P. falciparum prediction"),
       col=c("blue","cyan","darkgreen","red"),lty=c(1,1,1,1),lwd=c(1.5,1.5,1.5,1.5), cex=0.7,bg='white')
plot(dates,MT$Inci_viv,type="l",col="blue",ylim=c(0,max(MT$Inci_viv)),ylab="incidence",xlab="year",lwd=2,main="Mato Grosso")
lines(dates,MT$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
lines(dates,MA$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
...
lines(dates,TO$Pre_viv,type="l",col="cyan",lwd=1,lty=1)
