########################################################################
#                                                                      #
#    Bayesian models and falciparum incidence prediction (MATO GROSO)  #
#                                                                      #
########################################################################
### Packages
library(foreign)
...
proc.time()-t
# save results
# save(model.inla.5,file="MT_after_INLA_mes_fal_Ypred2016_2018_simples+spa_month_year_ate_2018.rdata")
load(file="MT_after_INLA_mes_fal_Ypred2016_2018_simples+spa_month_year_ate_2018.rdata")
...
save(Inci,file="MT_pre_fal.rdata")
...
#save(BASSER,file="MAPER_MT_fal.rdata")