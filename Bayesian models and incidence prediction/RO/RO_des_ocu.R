# Second Bayesian model: model deforestation, ocupations and imported cases
### Packages
library(beepr)
library(foreign)
library(lubridate)
...
RO_viv <- model.inla.1$summary.fixed[10:16,] 
#save(RO_viv,file="RO_viv_variavels.Rdata")
...
model.inla.1$dic$dic
# incidence increase from 1% of variable increase
RO_fal <- model.inla.1$summary.fixed[10:16,] 
#save(RO_fal,file="RO_fal_variavels.Rdata")
