########################################################################
#                                                                      #
#       Bayesian models and vivax incidence prediction (RONDONIA)      #
#                                                                      #
########################################################################
### Packages
library(foreign)
...
proc.time()-t
# save INLA results
#save(model.inla.5,file="RO_after_INLA_mes_viv_Ypred2016_2018_simples+spa_month_year_ate_2018.rdata")
load(file="RO_after_INLA_mes_viv_Ypred2016_2018_simples+spa_month_year_ate_2018.rdata")
...
# save results 
#save(Inci,file="RO_pre_viv.rdata")
...
# save results
#save(BASSER,file="MAPER_RO_viv.rdata")
