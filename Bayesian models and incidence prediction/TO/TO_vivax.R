########################################################################
#                                                                      #
#    Bayesian models and vivax incidence prediction (TOCANTINS)        #
#                                                                      #
########################################################################
### Packages
library(foreign)
...
proc.time()-t
# save results
# save(model.inla.5,file="TO_after_INLA_mes_viv_Ypred2016_2018_simples+spa_month_year_ate_2018.rdata")
load(file="TO_after_INLA_mes_viv_Ypred2016_2018_simples+spa_month_year_ate_2018.rdata")
...
# save(Inci,file="TO_pre_viv.rdata")
...
# save results
#save(BASSER,file="MAPER_TO_viv.rdata")
